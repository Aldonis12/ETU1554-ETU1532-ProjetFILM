...
public class Film {
    ...
    public ArrayList<Scene> Plannification(String debut, String fin, HibernateDAO dao,String[] list){
        ArrayList<Scene> listScene = new ArrayList<>();
        List<Scene> cesScene = this.listScene(dao,list);
        ArrayList<Plateau> listPlateau = this.plannifierScene(cesScene,listScene);
        ...
        this.plannificationPlateau(dao,deb,f,p,listPlateau,stocker,listScene,lir);
        return listScene;
    }
    ...
    public Plateau plateauProche(Plateau plateau,ArrayList<Plateau> list,ArrayList<Plateau> stocker){
        int i = 0, g = 0;
        Plateau p = null;
